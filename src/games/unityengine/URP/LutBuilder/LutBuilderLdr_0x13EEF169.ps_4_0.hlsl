  ...
  out float4 o0 : SV_Target0)
{
  ...
  if(injectedData.toneMapType != 0.f){
    r0.xyz = isWCG ? renodx::color::ap1::from::BT709(r0.xyz) : r0.xyz;
  }
  r0.xyz = max(float3(0,0,0), r0.xyz);
  /*bool dostuff = r0.x < 0.0 || r0.y < 0.0 || r0.z < 0.0;
  if(injectedData.toneMapType == 0.f){
  r0.xyz = max(float3(0,0,0), r0.xyz);
  } else {
    r0.xyz = !dostuff ? r0.xyz : renodx::color::bt2020::from::BT709(r0.xyz);
    r0.xyz = max(float3(0,0,0), r0.xyz);
  }*/
  ...
  float3 hdrColor = isWCG ? renodx::color::bt709::from::AP1(r0.xyz) : r0.xyz;
  ...
  o0.w = 1;
  if(injectedData.toneMapType != 0.f){
    o0.xyz = isWCG ? renodx::color::bt709::from::AP1(o0.xyz) : o0.xyz;
  }
  if (injectedData.toneMapType != 0.f) {
