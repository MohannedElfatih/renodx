...
float4 main(
  ...
  float _259 = exp2(log2(saturate((frame_consts.params.vignette.intensity * abs(_26 + -0.5f)) * ((((_16 / _17) + -1.0f) * frame_consts.params.vignette.rounded) + 1.0f))) * 5.0f);
  float _260 = exp2(log2(saturate(frame_consts.params.vignette.intensity * abs(_27 + -0.5f))) * 5.0f);
  float _273 = 1.0f - ((1.0f - exp2(log2(saturate(1.0f - dot(float2(_259, _260), float2(_259, _260)))) * 6.0f)) * 0.8500000238418579f);
  SV_Target.x = ((_273 * ((_136 - (_232 * _136)) - frame_consts.params.vignette.color.x)) + frame_consts.params.vignette.color.x);
  SV_Target.y = ((_273 * ((_137 - (_232 * _137)) - frame_consts.params.vignette.color.y)) + frame_consts.params.vignette.color.y);
  SV_Target.z = ((_273 * ((_138 - (_232 * _138)) - frame_consts.params.vignette.color.z)) + frame_consts.params.vignette.color.z);
