...
float4 main(
  ...
  float _677 = exp2(log2(saturate((_662 * abs(O_Uv.x + -0.5f)) * ((((_15 / _16) + -1.0f) * frame_consts.params.vignette.rounded) + 1.0f))) * 5.0f);
  float _678 = exp2(log2(saturate(_662 * abs(O_Uv.y + -0.5f))) * 5.0f);
  float _691 = 1.0f - ((1.0f - exp2(log2(saturate(1.0f - dot(float2(_677, _678), float2(_677, _678)))) * 6.0f)) * 0.8500000238418579f);
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _709 = ((_698 * 0.3930000066757202f) + (_699 * 0.7689999938011169f)) + (_700 * 0.1889999955892563f);
    float _714 = ((_698 * 0.3490000069141388f) + (_699 * 0.6859999895095825f)) + (_700 * 0.1679999977350235f);
    float _719 = ((_698 * 0.2720000147819519f) + (_699 * 0.5339999794960022f)) + (_700 * 0.13099999725818634f);
    float _720 = frame_consts.flashback_lut * 0.800000011920929f;
    float _725 = ((_698 * 0.2125999927520752f) + (_699 * 0.7152000069618225f)) + (_700 * 0.0722000002861023f);
    _745 = ((((_709 - _698) + ((_725 - _709) * 0.6499999761581421f)) * _720) + _698);
    _746 = ((((_714 - _699) + ((_725 - _714) * 0.6499999761581421f)) * _720) + _699);
    _747 = ((((_719 - _700) + ((_725 - _719) * 0.6499999761581421f)) * _720) + _700);
  } else {
    _745 = _698;
    _746 = _699;
    _747 = _700;
