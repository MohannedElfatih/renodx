...
float4 main(
  ...
  float _687 = ((_667 * 1.2000000476837158f) * _672) * frame_consts.params.vignette.golden_intensity;
  if (_687 > 0.0020000000949949026f) {
    float _692 = _15 * O_Uv.x;
    float _693 = _16 * O_Uv.y;
    float _694 = _692 + _693;
    float _700 = frac(_694 * 0.0033333334140479565f) + -0.5f;
    float _701 = frac((_693 - _692) * 0.0033333334140479565f) + -0.5f;
    float _707 = saturate(sqrt((_701 * _701) + (_700 * _700)) * 2.0f);
    float _718 = saturate((sin((_694 * 0.01666666753590107f) - (frame_consts.time * 0.8500000238418579f)) * 1.2500001192092896f) + -0.25000008940696716f);
    float _723 = ((_718 * _718) * 0.2199999988079071f) * (3.0f - (_718 * 2.0f));
    float _724 = _723 + 0.9777389168739319f;
    float _725 = ((_707 * 0.13274884223937988f) + 0.7175776362419128f) + _723;
    float _726 = ((_707 * 0.3335757553577423f) + 0.30871906876564026f) + _723;
    float _731 = (O_Uv.x * 1080.0f) * _648;
    float _732 = O_Uv.y * 1080.0f;
    float _733 = _731 * 0.04444444552063942f;
    float _734 = O_Uv.y * 27.712812423706055f;
    float _736 = ceil(_733 - _734);
    float _739 = floor(O_Uv.y * 55.42562484741211f) + 1.0f;
    float _742 = ceil((-0.0f - _734) - _733);
    float _744 = (_739 + _736) + _742;
    float _746 = (_744 * 22.5f) + -33.75f;
    float _748 = (_736 - _742) * 11.25f;
    float _754 = (((_739 * 0.5773502588272095f) - (_736 * 0.28867512941360474f)) - (_742 * 0.28867512941360474f)) * 22.5f;
    float _757 = _746 + _748;
    float _758 = _754 + (19.485570907592773f - (_744 * 12.990381240844727f));
    float _761 = ((_744 * 25.980762481689453f) + -38.97114181518555f) + _754;
    float _762 = _748 - _746;
    float _763 = _757 - _731;
    float _764 = _758 - _732;
    float _767 = _748 - _731;
    float _768 = _761 - _732;
    float _773 = _764 * _764;
    float _780 = _762 - _731;
    float _784 = frame_consts.time * 0.30000001192092896f;
    float _785 = _758 * 0.4000000059604645f;
    float _794 = sin(((_758 * 0.04444444552063942f) + _784) * 2.0f);
    float _799 = saturate((sqrt(_794 * cos((((_785 + _757) * 0.04444444552063942f) + _784) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _803 = (_799 * _799) * (3.0f - (_799 * 2.0f));
    float _805 = (_803 * 0.6499999761581421f) + 0.3499999940395355f;
    float _820 = saturate((sqrt(sin(((_761 * 0.04444444552063942f) + _784) * 2.0f) * cos(((((_761 * 0.4000000059604645f) + _748) * 0.04444444552063942f) + _784) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _824 = (_820 * _820) * (3.0f - (_820 * 2.0f));
    float _826 = (_824 * 0.6499999761581421f) + 0.3499999940395355f;
    float _836 = saturate((sqrt(cos((((_785 + _762) * 0.04444444552063942f) + _784) * 2.0f) * _794) * 2.0f) + 0.20000004768371582f);
    float _840 = (_836 * _836) * (3.0f - (_836 * 2.0f));
    float _842 = (_840 * 0.6499999761581421f) + 0.3499999940395355f;
    float _864 = saturate(_805);
    float _865 = saturate(_826);
    float _884 = ((((saturate(11.0f - (sqrt((_768 * _768) + (_767 * _767)) / ((_824 * 0.039000000804662704f) + 0.08100000768899918f))) * _826) + (saturate(11.0f - (sqrt((_763 * _763) + _773) / ((_803 * 0.039000000804662704f) + 0.08100000768899918f))) * _805)) + (saturate(11.0f - (sqrt((_780 * _780) + _773) / ((_840 * 0.039000000804662704f) + 0.08100000768899918f))) * _842)) + (((((saturate(1.0f - (abs(_764) * 0.8333333134651184f)) * _864) + (saturate(1.0f - (abs(dot(float2(_767, _768), float2(-0.8660253882408142f, 0.5f))) * 0.8333333134651184f)) * _865)) * saturate(_842)) + ((_864 * saturate(1.0f - (abs(dot(float2(_763, _764), float2(0.8660253882408142f, 0.5f))) * 0.8333333134651184f))) * _865)) * 0.5f)) * _687;
    _895 = ((_884 * ((_724 * _724) - _681)) + _681);
    _896 = ((_884 * ((_725 * _725) - _682)) + _682);
    _897 = ((_884 * ((_726 * _726) - _683)) + _683);
  } else {
    _895 = _681;
    _896 = _682;
    _897 = _683;
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _906 = ((_896 * 0.7689999938011169f) + (_895 * 0.3930000066757202f)) + (_897 * 0.1889999955892563f);
    float _911 = ((_896 * 0.6859999895095825f) + (_895 * 0.3490000069141388f)) + (_897 * 0.1679999977350235f);
    float _916 = ((_896 * 0.5339999794960022f) + (_895 * 0.2720000147819519f)) + (_897 * 0.13099999725818634f);
    float _917 = frame_consts.flashback_lut * 0.800000011920929f;
    float _922 = ((_896 * 0.7152000069618225f) + (_895 * 0.2125999927520752f)) + (_897 * 0.0722000002861023f);
    _942 = ((((_906 - _895) + ((_922 - _906) * 0.6499999761581421f)) * _917) + _895);
    _943 = ((((_911 - _896) + ((_922 - _911) * 0.6499999761581421f)) * _917) + _896);
    _944 = ((((_916 - _897) + ((_922 - _916) * 0.6499999761581421f)) * _917) + _897);
  } else {
    _942 = _895;
    _943 = _896;
    _944 = _897;
