...
float4 main(
  ...
  float _295 = exp2(log2(saturate((frame_consts.params.vignette.intensity * abs(_26 + -0.5f)) * ((((_16 / _17) + -1.0f) * frame_consts.params.vignette.rounded) + 1.0f))) * 5.0f);
  float _296 = exp2(log2(saturate(frame_consts.params.vignette.intensity * abs(_27 + -0.5f))) * 5.0f);
  float _309 = 1.0f - ((1.0f - exp2(log2(saturate(1.0f - dot(float2(_295, _296), float2(_295, _296)))) * 6.0f)) * 0.8500000238418579f);
  SV_Target.x = ((_309 * ((_136 - (_268 * _136)) - frame_consts.params.vignette.color.x)) + frame_consts.params.vignette.color.x);
  SV_Target.y = ((_309 * ((_137 - (_268 * _137)) - frame_consts.params.vignette.color.y)) + frame_consts.params.vignette.color.y);
  SV_Target.z = ((_309 * ((_138 - (_268 * _138)) - frame_consts.params.vignette.color.z)) + frame_consts.params.vignette.color.z);
