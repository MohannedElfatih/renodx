...
float4 main(
  ...
  float _732 = exp2(log2(saturate((_717 * abs(_26 + -0.5f)) * ((((_16 / _17) + -1.0f) * frame_consts.params.vignette.rounded) + 1.0f))) * 5.0f);
  float _733 = exp2(log2(saturate(_717 * abs(_27 + -0.5f))) * 5.0f);
  float _746 = 1.0f - ((1.0f - exp2(log2(saturate(1.0f - dot(float2(_732, _733), float2(_732, _733)))) * 6.0f)) * 0.8500000238418579f);
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _764 = ((_753 * 0.3930000066757202f) + (_754 * 0.7689999938011169f)) + (_755 * 0.1889999955892563f);
    float _769 = ((_753 * 0.3490000069141388f) + (_754 * 0.6859999895095825f)) + (_755 * 0.1679999977350235f);
    float _774 = ((_753 * 0.2720000147819519f) + (_754 * 0.5339999794960022f)) + (_755 * 0.13099999725818634f);
    float _775 = frame_consts.flashback_lut * 0.800000011920929f;
    float _780 = ((_753 * 0.2125999927520752f) + (_754 * 0.7152000069618225f)) + (_755 * 0.0722000002861023f);
    _800 = ((((_764 - _753) + ((_780 - _764) * 0.6499999761581421f)) * _775) + _753);
    _801 = ((((_769 - _754) + ((_780 - _769) * 0.6499999761581421f)) * _775) + _754);
    _802 = ((((_774 - _755) + ((_780 - _774) * 0.6499999761581421f)) * _775) + _755);
  } else {
    _800 = _753;
    _801 = _754;
    _802 = _755;
