...
float4 main(
  ...
  float _660 = exp2(log2(saturate((_645 * abs(O_Uv.x + -0.5f)) * ((((_15 / _16) + -1.0f) * frame_consts.params.vignette.rounded) + 1.0f))) * 5.0f);
  float _661 = exp2(log2(saturate(_645 * abs(O_Uv.y + -0.5f))) * 5.0f);
  float _674 = 1.0f - ((1.0f - exp2(log2(saturate(1.0f - dot(float2(_660, _661), float2(_660, _661)))) * 6.0f)) * 0.8500000238418579f);
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _692 = ((_681 * 0.3930000066757202f) + (_682 * 0.7689999938011169f)) + (_683 * 0.1889999955892563f);
    float _697 = ((_681 * 0.3490000069141388f) + (_682 * 0.6859999895095825f)) + (_683 * 0.1679999977350235f);
    float _702 = ((_681 * 0.2720000147819519f) + (_682 * 0.5339999794960022f)) + (_683 * 0.13099999725818634f);
    float _703 = frame_consts.flashback_lut * 0.800000011920929f;
    float _708 = ((_681 * 0.2125999927520752f) + (_682 * 0.7152000069618225f)) + (_683 * 0.0722000002861023f);
    _728 = ((((_692 - _681) + ((_708 - _692) * 0.6499999761581421f)) * _703) + _681);
    _729 = ((((_697 - _682) + ((_708 - _697) * 0.6499999761581421f)) * _703) + _682);
    _730 = ((((_702 - _683) + ((_708 - _702) * 0.6499999761581421f)) * _703) + _683);
  } else {
    _728 = _681;
    _729 = _682;
    _730 = _683;
