...
float4 main(
  ...
  float _674 = ((_654 * 1.2000000476837158f) * _659) * frame_consts.params.vignette.golden_intensity;
  if (_674 > 0.0020000000949949026f) {
    float _679 = _14 * O_Uv.x;
    float _680 = _15 * O_Uv.y;
    float _681 = _679 + _680;
    float _687 = frac(_681 * 0.0033333334140479565f) + -0.5f;
    float _688 = frac((_680 - _679) * 0.0033333334140479565f) + -0.5f;
    float _694 = saturate(sqrt((_688 * _688) + (_687 * _687)) * 2.0f);
    float _705 = saturate((sin((_681 * 0.01666666753590107f) - (frame_consts.time * 0.8500000238418579f)) * 1.2500001192092896f) + -0.25000008940696716f);
    float _710 = ((_705 * _705) * 0.2199999988079071f) * (3.0f - (_705 * 2.0f));
    float _711 = _710 + 0.9777389168739319f;
    float _712 = ((_694 * 0.13274884223937988f) + 0.7175776362419128f) + _710;
    float _713 = ((_694 * 0.3335757553577423f) + 0.30871906876564026f) + _710;
    float _718 = (O_Uv.x * 1080.0f) * _635;
    float _719 = O_Uv.y * 1080.0f;
    float _720 = _718 * 0.04444444552063942f;
    float _721 = O_Uv.y * 27.712812423706055f;
    float _723 = ceil(_720 - _721);
    float _726 = floor(O_Uv.y * 55.42562484741211f) + 1.0f;
    float _729 = ceil((-0.0f - _721) - _720);
    float _731 = (_726 + _723) + _729;
    float _733 = (_731 * 22.5f) + -33.75f;
    float _735 = (_723 - _729) * 11.25f;
    float _741 = (((_726 * 0.5773502588272095f) - (_723 * 0.28867512941360474f)) - (_729 * 0.28867512941360474f)) * 22.5f;
    float _744 = _733 + _735;
    float _745 = _741 + (19.485570907592773f - (_731 * 12.990381240844727f));
    float _748 = ((_731 * 25.980762481689453f) + -38.97114181518555f) + _741;
    float _749 = _735 - _733;
    float _750 = _744 - _718;
    float _751 = _745 - _719;
    float _754 = _735 - _718;
    float _755 = _748 - _719;
    float _760 = _751 * _751;
    float _767 = _749 - _718;
    float _771 = frame_consts.time * 0.30000001192092896f;
    float _772 = _745 * 0.4000000059604645f;
    float _781 = sin(((_745 * 0.04444444552063942f) + _771) * 2.0f);
    float _786 = saturate((sqrt(_781 * cos((((_772 + _744) * 0.04444444552063942f) + _771) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _790 = (_786 * _786) * (3.0f - (_786 * 2.0f));
    float _792 = (_790 * 0.6499999761581421f) + 0.3499999940395355f;
    float _807 = saturate((sqrt(sin(((_748 * 0.04444444552063942f) + _771) * 2.0f) * cos(((((_748 * 0.4000000059604645f) + _735) * 0.04444444552063942f) + _771) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _811 = (_807 * _807) * (3.0f - (_807 * 2.0f));
    float _813 = (_811 * 0.6499999761581421f) + 0.3499999940395355f;
    float _823 = saturate((sqrt(cos((((_772 + _749) * 0.04444444552063942f) + _771) * 2.0f) * _781) * 2.0f) + 0.20000004768371582f);
    float _827 = (_823 * _823) * (3.0f - (_823 * 2.0f));
    float _829 = (_827 * 0.6499999761581421f) + 0.3499999940395355f;
    float _851 = saturate(_792);
    float _852 = saturate(_813);
    float _871 = ((((saturate(11.0f - (sqrt((_755 * _755) + (_754 * _754)) / ((_811 * 0.039000000804662704f) + 0.08100000768899918f))) * _813) + (saturate(11.0f - (sqrt((_750 * _750) + _760) / ((_790 * 0.039000000804662704f) + 0.08100000768899918f))) * _792)) + (saturate(11.0f - (sqrt((_767 * _767) + _760) / ((_827 * 0.039000000804662704f) + 0.08100000768899918f))) * _829)) + (((((saturate(1.0f - (abs(_751) * 0.8333333134651184f)) * _851) + (saturate(1.0f - (abs(dot(float2(_754, _755), float2(-0.8660253882408142f, 0.5f))) * 0.8333333134651184f)) * _852)) * saturate(_829)) + ((_851 * saturate(1.0f - (abs(dot(float2(_750, _751), float2(0.8660253882408142f, 0.5f))) * 0.8333333134651184f))) * _852)) * 0.5f)) * _674;
    _882 = ((_871 * ((_711 * _711) - _668)) + _668);
    _883 = ((_871 * ((_712 * _712) - _669)) + _669);
    _884 = ((_871 * ((_713 * _713) - _670)) + _670);
  } else {
    _882 = _668;
    _883 = _669;
    _884 = _670;
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _893 = ((_883 * 0.7689999938011169f) + (_882 * 0.3930000066757202f)) + (_884 * 0.1889999955892563f);
    float _898 = ((_883 * 0.6859999895095825f) + (_882 * 0.3490000069141388f)) + (_884 * 0.1679999977350235f);
    float _903 = ((_883 * 0.5339999794960022f) + (_882 * 0.2720000147819519f)) + (_884 * 0.13099999725818634f);
    float _904 = frame_consts.flashback_lut * 0.800000011920929f;
    float _909 = ((_883 * 0.7152000069618225f) + (_882 * 0.2125999927520752f)) + (_884 * 0.0722000002861023f);
    _929 = ((((_893 - _882) + ((_909 - _893) * 0.6499999761581421f)) * _904) + _882);
    _930 = ((((_898 - _883) + ((_909 - _898) * 0.6499999761581421f)) * _904) + _883);
    _931 = ((((_903 - _884) + ((_909 - _903) * 0.6499999761581421f)) * _904) + _884);
  } else {
    _929 = _882;
    _930 = _883;
    _931 = _884;
