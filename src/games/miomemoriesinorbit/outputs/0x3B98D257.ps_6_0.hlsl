...
float4 main(
  ...
  float _597 = exp2(log2(saturate((_582 * abs(_25 + -0.5f)) * ((((_15 / _16) + -1.0f) * frame_consts.params.vignette.rounded) + 1.0f))) * 5.0f);
  float _598 = exp2(log2(saturate(_582 * abs(_26 + -0.5f))) * 5.0f);
  float _611 = 1.0f - ((1.0f - exp2(log2(saturate(1.0f - dot(float2(_597, _598), float2(_597, _598)))) * 6.0f)) * 0.8500000238418579f);
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _629 = ((_618 * 0.3930000066757202f) + (_619 * 0.7689999938011169f)) + (_620 * 0.1889999955892563f);
    float _634 = ((_618 * 0.3490000069141388f) + (_619 * 0.6859999895095825f)) + (_620 * 0.1679999977350235f);
    float _639 = ((_618 * 0.2720000147819519f) + (_619 * 0.5339999794960022f)) + (_620 * 0.13099999725818634f);
    float _640 = frame_consts.flashback_lut * 0.800000011920929f;
    float _645 = ((_618 * 0.2125999927520752f) + (_619 * 0.7152000069618225f)) + (_620 * 0.0722000002861023f);
    _665 = ((((_629 - _618) + ((_645 - _629) * 0.6499999761581421f)) * _640) + _618);
    _666 = ((((_634 - _619) + ((_645 - _634) * 0.6499999761581421f)) * _640) + _619);
    _667 = ((((_639 - _620) + ((_645 - _639) * 0.6499999761581421f)) * _640) + _620);
  } else {
    _665 = _618;
    _666 = _619;
    _667 = _620;
