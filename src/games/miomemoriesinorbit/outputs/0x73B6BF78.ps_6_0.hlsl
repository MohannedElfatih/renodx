...
float4 main(
  ...
  float _696 = exp2(log2(saturate((_681 * abs(_26 + -0.5f)) * ((((_16 / _17) + -1.0f) * frame_consts.params.vignette.rounded) + 1.0f))) * 5.0f);
  float _697 = exp2(log2(saturate(_681 * abs(_27 + -0.5f))) * 5.0f);
  float _710 = 1.0f - ((1.0f - exp2(log2(saturate(1.0f - dot(float2(_696, _697), float2(_696, _697)))) * 6.0f)) * 0.8500000238418579f);
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _728 = ((_717 * 0.3930000066757202f) + (_718 * 0.7689999938011169f)) + (_719 * 0.1889999955892563f);
    float _733 = ((_717 * 0.3490000069141388f) + (_718 * 0.6859999895095825f)) + (_719 * 0.1679999977350235f);
    float _738 = ((_717 * 0.2720000147819519f) + (_718 * 0.5339999794960022f)) + (_719 * 0.13099999725818634f);
    float _739 = frame_consts.flashback_lut * 0.800000011920929f;
    float _744 = ((_717 * 0.2125999927520752f) + (_718 * 0.7152000069618225f)) + (_719 * 0.0722000002861023f);
    _764 = ((((_728 - _717) + ((_744 - _728) * 0.6499999761581421f)) * _739) + _717);
    _765 = ((((_733 - _718) + ((_744 - _733) * 0.6499999761581421f)) * _739) + _718);
    _766 = ((((_738 - _719) + ((_744 - _738) * 0.6499999761581421f)) * _739) + _719);
  } else {
    _764 = _717;
    _765 = _718;
    _766 = _719;
