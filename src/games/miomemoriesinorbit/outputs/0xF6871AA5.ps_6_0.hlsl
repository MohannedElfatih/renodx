...
float4 main(
  ...
  float _715 = ((_695 * 1.2000000476837158f) * _700) * frame_consts.params.vignette.golden_intensity;
  if (_715 > 0.0020000000949949026f) {
    float _720 = _26 * _16;
    float _721 = _27 * _17;
    float _722 = _721 + _720;
    float _728 = frac(_722 * 0.0033333334140479565f) + -0.5f;
    float _729 = frac((_721 - _720) * 0.0033333334140479565f) + -0.5f;
    float _735 = saturate(sqrt((_729 * _729) + (_728 * _728)) * 2.0f);
    float _746 = saturate((sin((_722 * 0.01666666753590107f) - (frame_consts.time * 0.8500000238418579f)) * 1.2500001192092896f) + -0.25000008940696716f);
    float _751 = ((_746 * _746) * 0.2199999988079071f) * (3.0f - (_746 * 2.0f));
    float _752 = _751 + 0.9777389168739319f;
    float _753 = ((_735 * 0.13274884223937988f) + 0.7175776362419128f) + _751;
    float _754 = ((_735 * 0.3335757553577423f) + 0.30871906876564026f) + _751;
    float _759 = (_26 * 1080.0f) * _676;
    float _760 = _27 * 1080.0f;
    float _761 = _759 * 0.04444444552063942f;
    float _762 = _27 * 27.712812423706055f;
    float _764 = ceil(_761 - _762);
    float _767 = floor(_27 * 55.42562484741211f) + 1.0f;
    float _770 = ceil((-0.0f - _762) - _761);
    float _772 = (_767 + _764) + _770;
    float _774 = (_772 * 22.5f) + -33.75f;
    float _776 = (_764 - _770) * 11.25f;
    float _782 = (((_767 * 0.5773502588272095f) - (_764 * 0.28867512941360474f)) - (_770 * 0.28867512941360474f)) * 22.5f;
    float _785 = _774 + _776;
    float _786 = _782 + (19.485570907592773f - (_772 * 12.990381240844727f));
    float _789 = ((_772 * 25.980762481689453f) + -38.97114181518555f) + _782;
    float _790 = _776 - _774;
    float _791 = _785 - _759;
    float _792 = _786 - _760;
    float _795 = _776 - _759;
    float _796 = _789 - _760;
    float _801 = _792 * _792;
    float _808 = _790 - _759;
    float _812 = frame_consts.time * 0.30000001192092896f;
    float _813 = _786 * 0.4000000059604645f;
    float _822 = sin(((_786 * 0.04444444552063942f) + _812) * 2.0f);
    float _827 = saturate((sqrt(_822 * cos((((_813 + _785) * 0.04444444552063942f) + _812) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _831 = (_827 * _827) * (3.0f - (_827 * 2.0f));
    float _833 = (_831 * 0.6499999761581421f) + 0.3499999940395355f;
    float _848 = saturate((sqrt(sin(((_789 * 0.04444444552063942f) + _812) * 2.0f) * cos(((((_789 * 0.4000000059604645f) + _776) * 0.04444444552063942f) + _812) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _852 = (_848 * _848) * (3.0f - (_848 * 2.0f));
    float _854 = (_852 * 0.6499999761581421f) + 0.3499999940395355f;
    float _864 = saturate((sqrt(cos((((_813 + _790) * 0.04444444552063942f) + _812) * 2.0f) * _822) * 2.0f) + 0.20000004768371582f);
    float _868 = (_864 * _864) * (3.0f - (_864 * 2.0f));
    float _870 = (_868 * 0.6499999761581421f) + 0.3499999940395355f;
    float _892 = saturate(_833);
    float _893 = saturate(_854);
    float _912 = ((((saturate(11.0f - (sqrt((_796 * _796) + (_795 * _795)) / ((_852 * 0.039000000804662704f) + 0.08100000768899918f))) * _854) + (saturate(11.0f - (sqrt((_791 * _791) + _801) / ((_831 * 0.039000000804662704f) + 0.08100000768899918f))) * _833)) + (saturate(11.0f - (sqrt((_808 * _808) + _801) / ((_868 * 0.039000000804662704f) + 0.08100000768899918f))) * _870)) + (((((saturate(1.0f - (abs(_792) * 0.8333333134651184f)) * _892) + (saturate(1.0f - (abs(dot(float2(_795, _796), float2(-0.8660253882408142f, 0.5f))) * 0.8333333134651184f)) * _893)) * saturate(_870)) + ((_892 * saturate(1.0f - (abs(dot(float2(_791, _792), float2(0.8660253882408142f, 0.5f))) * 0.8333333134651184f))) * _893)) * 0.5f)) * _715;
    _923 = ((_912 * ((_752 * _752) - _709)) + _709);
    _924 = ((_912 * ((_753 * _753) - _710)) + _710);
    _925 = ((_912 * ((_754 * _754) - _711)) + _711);
  } else {
    _923 = _709;
    _924 = _710;
    _925 = _711;
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _934 = ((_924 * 0.7689999938011169f) + (_923 * 0.3930000066757202f)) + (_925 * 0.1889999955892563f);
    float _939 = ((_924 * 0.6859999895095825f) + (_923 * 0.3490000069141388f)) + (_925 * 0.1679999977350235f);
    float _944 = ((_924 * 0.5339999794960022f) + (_923 * 0.2720000147819519f)) + (_925 * 0.13099999725818634f);
    float _945 = frame_consts.flashback_lut * 0.800000011920929f;
    float _950 = ((_924 * 0.7152000069618225f) + (_923 * 0.2125999927520752f)) + (_925 * 0.0722000002861023f);
    _970 = ((((_934 - _923) + ((_950 - _934) * 0.6499999761581421f)) * _945) + _923);
    _971 = ((((_939 - _924) + ((_950 - _939) * 0.6499999761581421f)) * _945) + _924);
    _972 = ((((_944 - _925) + ((_950 - _944) * 0.6499999761581421f)) * _945) + _925);
  } else {
    _970 = _923;
    _971 = _924;
    _972 = _925;
