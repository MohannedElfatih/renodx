...
float4 main(
  ...
  float _603 = exp2(log2(saturate((_588 * abs(O_Uv.x + -0.5f)) * ((((_14 / _15) + -1.0f) * frame_consts.params.vignette.rounded) + 1.0f))) * 5.0f);
  float _604 = exp2(log2(saturate(_588 * abs(O_Uv.y + -0.5f))) * 5.0f);
  float _617 = 1.0f - ((1.0f - exp2(log2(saturate(1.0f - dot(float2(_603, _604), float2(_603, _604)))) * 6.0f)) * 0.8500000238418579f);
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _635 = ((_624 * 0.3930000066757202f) + (_625 * 0.7689999938011169f)) + (_626 * 0.1889999955892563f);
    float _640 = ((_624 * 0.3490000069141388f) + (_625 * 0.6859999895095825f)) + (_626 * 0.1679999977350235f);
    float _645 = ((_624 * 0.2720000147819519f) + (_625 * 0.5339999794960022f)) + (_626 * 0.13099999725818634f);
    float _646 = frame_consts.flashback_lut * 0.800000011920929f;
    float _651 = ((_624 * 0.2125999927520752f) + (_625 * 0.7152000069618225f)) + (_626 * 0.0722000002861023f);
    _671 = ((((_635 - _624) + ((_651 - _635) * 0.6499999761581421f)) * _646) + _624);
    _672 = ((((_640 - _625) + ((_651 - _640) * 0.6499999761581421f)) * _646) + _625);
    _673 = ((((_645 - _626) + ((_651 - _645) * 0.6499999761581421f)) * _646) + _626);
  } else {
    _671 = _624;
    _672 = _625;
    _673 = _626;
