...
float4 main(
  ...
  float _649 = ((_629 * 1.2000000476837158f) * _634) * frame_consts.params.vignette.golden_intensity;
  if (_649 > 0.0020000000949949026f) {
    float _654 = _25 * _15;
    float _655 = _26 * _16;
    float _656 = _655 + _654;
    float _662 = frac(_656 * 0.0033333334140479565f) + -0.5f;
    float _663 = frac((_655 - _654) * 0.0033333334140479565f) + -0.5f;
    float _669 = saturate(sqrt((_663 * _663) + (_662 * _662)) * 2.0f);
    float _680 = saturate((sin((_656 * 0.01666666753590107f) - (frame_consts.time * 0.8500000238418579f)) * 1.2500001192092896f) + -0.25000008940696716f);
    float _685 = ((_680 * _680) * 0.2199999988079071f) * (3.0f - (_680 * 2.0f));
    float _686 = _685 + 0.9777389168739319f;
    float _687 = ((_669 * 0.13274884223937988f) + 0.7175776362419128f) + _685;
    float _688 = ((_669 * 0.3335757553577423f) + 0.30871906876564026f) + _685;
    float _693 = (_25 * 1080.0f) * _610;
    float _694 = _26 * 1080.0f;
    float _695 = _693 * 0.04444444552063942f;
    float _696 = _26 * 27.712812423706055f;
    float _698 = ceil(_695 - _696);
    float _701 = floor(_26 * 55.42562484741211f) + 1.0f;
    float _704 = ceil((-0.0f - _696) - _695);
    float _706 = (_701 + _698) + _704;
    float _708 = (_706 * 22.5f) + -33.75f;
    float _710 = (_698 - _704) * 11.25f;
    float _716 = (((_701 * 0.5773502588272095f) - (_698 * 0.28867512941360474f)) - (_704 * 0.28867512941360474f)) * 22.5f;
    float _719 = _708 + _710;
    float _720 = _716 + (19.485570907592773f - (_706 * 12.990381240844727f));
    float _723 = ((_706 * 25.980762481689453f) + -38.97114181518555f) + _716;
    float _724 = _710 - _708;
    float _725 = _719 - _693;
    float _726 = _720 - _694;
    float _729 = _710 - _693;
    float _730 = _723 - _694;
    float _735 = _726 * _726;
    float _742 = _724 - _693;
    float _746 = frame_consts.time * 0.30000001192092896f;
    float _747 = _720 * 0.4000000059604645f;
    float _756 = sin(((_720 * 0.04444444552063942f) + _746) * 2.0f);
    float _761 = saturate((sqrt(_756 * cos((((_747 + _719) * 0.04444444552063942f) + _746) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _765 = (_761 * _761) * (3.0f - (_761 * 2.0f));
    float _767 = (_765 * 0.6499999761581421f) + 0.3499999940395355f;
    float _782 = saturate((sqrt(sin(((_723 * 0.04444444552063942f) + _746) * 2.0f) * cos(((((_723 * 0.4000000059604645f) + _710) * 0.04444444552063942f) + _746) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _786 = (_782 * _782) * (3.0f - (_782 * 2.0f));
    float _788 = (_786 * 0.6499999761581421f) + 0.3499999940395355f;
    float _798 = saturate((sqrt(cos((((_747 + _724) * 0.04444444552063942f) + _746) * 2.0f) * _756) * 2.0f) + 0.20000004768371582f);
    float _802 = (_798 * _798) * (3.0f - (_798 * 2.0f));
    float _804 = (_802 * 0.6499999761581421f) + 0.3499999940395355f;
    float _826 = saturate(_767);
    float _827 = saturate(_788);
    float _846 = ((((saturate(11.0f - (sqrt((_730 * _730) + (_729 * _729)) / ((_786 * 0.039000000804662704f) + 0.08100000768899918f))) * _788) + (saturate(11.0f - (sqrt((_725 * _725) + _735) / ((_765 * 0.039000000804662704f) + 0.08100000768899918f))) * _767)) + (saturate(11.0f - (sqrt((_742 * _742) + _735) / ((_802 * 0.039000000804662704f) + 0.08100000768899918f))) * _804)) + (((((saturate(1.0f - (abs(_726) * 0.8333333134651184f)) * _826) + (saturate(1.0f - (abs(dot(float2(_729, _730), float2(-0.8660253882408142f, 0.5f))) * 0.8333333134651184f)) * _827)) * saturate(_804)) + ((_826 * saturate(1.0f - (abs(dot(float2(_725, _726), float2(0.8660253882408142f, 0.5f))) * 0.8333333134651184f))) * _827)) * 0.5f)) * _649;
    _857 = ((_846 * ((_686 * _686) - _643)) + _643);
    _858 = ((_846 * ((_687 * _687) - _644)) + _644);
    _859 = ((_846 * ((_688 * _688) - _645)) + _645);
  } else {
    _857 = _643;
    _858 = _644;
    _859 = _645;
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _868 = ((_858 * 0.7689999938011169f) + (_857 * 0.3930000066757202f)) + (_859 * 0.1889999955892563f);
    float _873 = ((_858 * 0.6859999895095825f) + (_857 * 0.3490000069141388f)) + (_859 * 0.1679999977350235f);
    float _878 = ((_858 * 0.5339999794960022f) + (_857 * 0.2720000147819519f)) + (_859 * 0.13099999725818634f);
    float _879 = frame_consts.flashback_lut * 0.800000011920929f;
    float _884 = ((_858 * 0.7152000069618225f) + (_857 * 0.2125999927520752f)) + (_859 * 0.0722000002861023f);
    _904 = ((((_868 - _857) + ((_884 - _868) * 0.6499999761581421f)) * _879) + _857);
    _905 = ((((_873 - _858) + ((_884 - _873) * 0.6499999761581421f)) * _879) + _858);
    _906 = ((((_878 - _859) + ((_884 - _878) * 0.6499999761581421f)) * _879) + _859);
  } else {
    _904 = _857;
    _905 = _858;
    _906 = _859;
