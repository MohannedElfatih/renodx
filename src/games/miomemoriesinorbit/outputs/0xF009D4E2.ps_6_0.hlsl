...
float4 main(
  ...
  float _748 = ((_728 * 1.2000000476837158f) * _733) * frame_consts.params.vignette.golden_intensity;
  if (_748 > 0.0020000000949949026f) {
    float _753 = _15 * O_Uv.x;
    float _754 = _16 * O_Uv.y;
    float _755 = _753 + _754;
    float _761 = frac(_755 * 0.0033333334140479565f) + -0.5f;
    float _762 = frac((_754 - _753) * 0.0033333334140479565f) + -0.5f;
    float _768 = saturate(sqrt((_762 * _762) + (_761 * _761)) * 2.0f);
    float _779 = saturate((sin((_755 * 0.01666666753590107f) - (frame_consts.time * 0.8500000238418579f)) * 1.2500001192092896f) + -0.25000008940696716f);
    float _784 = ((_779 * _779) * 0.2199999988079071f) * (3.0f - (_779 * 2.0f));
    float _785 = _784 + 0.9777389168739319f;
    float _786 = ((_768 * 0.13274884223937988f) + 0.7175776362419128f) + _784;
    float _787 = ((_768 * 0.3335757553577423f) + 0.30871906876564026f) + _784;
    float _792 = (O_Uv.x * 1080.0f) * _709;
    float _793 = O_Uv.y * 1080.0f;
    float _794 = _792 * 0.04444444552063942f;
    float _795 = O_Uv.y * 27.712812423706055f;
    float _797 = ceil(_794 - _795);
    float _800 = floor(O_Uv.y * 55.42562484741211f) + 1.0f;
    float _803 = ceil((-0.0f - _795) - _794);
    float _805 = (_800 + _797) + _803;
    float _807 = (_805 * 22.5f) + -33.75f;
    float _809 = (_797 - _803) * 11.25f;
    float _815 = (((_800 * 0.5773502588272095f) - (_797 * 0.28867512941360474f)) - (_803 * 0.28867512941360474f)) * 22.5f;
    float _818 = _807 + _809;
    float _819 = _815 + (19.485570907592773f - (_805 * 12.990381240844727f));
    float _822 = ((_805 * 25.980762481689453f) + -38.97114181518555f) + _815;
    float _823 = _809 - _807;
    float _824 = _818 - _792;
    float _825 = _819 - _793;
    float _828 = _809 - _792;
    float _829 = _822 - _793;
    float _834 = _825 * _825;
    float _841 = _823 - _792;
    float _845 = frame_consts.time * 0.30000001192092896f;
    float _846 = _819 * 0.4000000059604645f;
    float _855 = sin(((_819 * 0.04444444552063942f) + _845) * 2.0f);
    float _860 = saturate((sqrt(_855 * cos((((_846 + _818) * 0.04444444552063942f) + _845) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _864 = (_860 * _860) * (3.0f - (_860 * 2.0f));
    float _866 = (_864 * 0.6499999761581421f) + 0.3499999940395355f;
    float _881 = saturate((sqrt(sin(((_822 * 0.04444444552063942f) + _845) * 2.0f) * cos(((((_822 * 0.4000000059604645f) + _809) * 0.04444444552063942f) + _845) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _885 = (_881 * _881) * (3.0f - (_881 * 2.0f));
    float _887 = (_885 * 0.6499999761581421f) + 0.3499999940395355f;
    float _897 = saturate((sqrt(cos((((_846 + _823) * 0.04444444552063942f) + _845) * 2.0f) * _855) * 2.0f) + 0.20000004768371582f);
    float _901 = (_897 * _897) * (3.0f - (_897 * 2.0f));
    float _903 = (_901 * 0.6499999761581421f) + 0.3499999940395355f;
    float _925 = saturate(_866);
    float _926 = saturate(_887);
    float _945 = ((((saturate(11.0f - (sqrt((_829 * _829) + (_828 * _828)) / ((_885 * 0.039000000804662704f) + 0.08100000768899918f))) * _887) + (saturate(11.0f - (sqrt((_824 * _824) + _834) / ((_864 * 0.039000000804662704f) + 0.08100000768899918f))) * _866)) + (saturate(11.0f - (sqrt((_841 * _841) + _834) / ((_901 * 0.039000000804662704f) + 0.08100000768899918f))) * _903)) + (((((saturate(1.0f - (abs(_825) * 0.8333333134651184f)) * _925) + (saturate(1.0f - (abs(dot(float2(_828, _829), float2(-0.8660253882408142f, 0.5f))) * 0.8333333134651184f)) * _926)) * saturate(_903)) + ((_925 * saturate(1.0f - (abs(dot(float2(_824, _825), float2(0.8660253882408142f, 0.5f))) * 0.8333333134651184f))) * _926)) * 0.5f)) * _748;
    _956 = ((_945 * ((_785 * _785) - _742)) + _742);
    _957 = ((_945 * ((_786 * _786) - _743)) + _743);
    _958 = ((_945 * ((_787 * _787) - _744)) + _744);
  } else {
    _956 = _742;
    _957 = _743;
    _958 = _744;
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _967 = ((_957 * 0.7689999938011169f) + (_956 * 0.3930000066757202f)) + (_958 * 0.1889999955892563f);
    float _972 = ((_957 * 0.6859999895095825f) + (_956 * 0.3490000069141388f)) + (_958 * 0.1679999977350235f);
    float _977 = ((_957 * 0.5339999794960022f) + (_956 * 0.2720000147819519f)) + (_958 * 0.13099999725818634f);
    float _978 = frame_consts.flashback_lut * 0.800000011920929f;
    float _983 = ((_957 * 0.7152000069618225f) + (_956 * 0.2125999927520752f)) + (_958 * 0.0722000002861023f);
    _1003 = ((((_967 - _956) + ((_983 - _967) * 0.6499999761581421f)) * _978) + _956);
    _1004 = ((((_972 - _957) + ((_983 - _972) * 0.6499999761581421f)) * _978) + _957);
    _1005 = ((((_977 - _958) + ((_983 - _977) * 0.6499999761581421f)) * _978) + _958);
  } else {
    _1003 = _956;
    _1004 = _957;
    _1005 = _958;
