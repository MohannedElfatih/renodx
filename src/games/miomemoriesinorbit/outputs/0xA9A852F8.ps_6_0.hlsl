...
float4 main(
  ...
  float _685 = exp2(log2(saturate((_670 * abs(O_Uv.x + -0.5f)) * ((((_15 / _16) + -1.0f) * frame_consts.params.vignette.rounded) + 1.0f))) * 5.0f);
  float _686 = exp2(log2(saturate(_670 * abs(O_Uv.y + -0.5f))) * 5.0f);
  float _699 = 1.0f - ((1.0f - exp2(log2(saturate(1.0f - dot(float2(_685, _686), float2(_685, _686)))) * 6.0f)) * 0.8500000238418579f);
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _717 = ((_706 * 0.3930000066757202f) + (_707 * 0.7689999938011169f)) + (_708 * 0.1889999955892563f);
    float _722 = ((_706 * 0.3490000069141388f) + (_707 * 0.6859999895095825f)) + (_708 * 0.1679999977350235f);
    float _727 = ((_706 * 0.2720000147819519f) + (_707 * 0.5339999794960022f)) + (_708 * 0.13099999725818634f);
    float _728 = frame_consts.flashback_lut * 0.800000011920929f;
    float _733 = ((_706 * 0.2125999927520752f) + (_707 * 0.7152000069618225f)) + (_708 * 0.0722000002861023f);
    _753 = ((((_717 - _706) + ((_733 - _717) * 0.6499999761581421f)) * _728) + _706);
    _754 = ((((_722 - _707) + ((_733 - _722) * 0.6499999761581421f)) * _728) + _707);
    _755 = ((((_727 - _708) + ((_733 - _727) * 0.6499999761581421f)) * _728) + _708);
  } else {
    _753 = _706;
    _754 = _707;
    _755 = _708;
