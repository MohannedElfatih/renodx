...
float4 main(
  ...
  float _611 = exp2(log2(saturate((_596 * abs(O_Uv.x + -0.5f)) * ((((_14 / _15) + -1.0f) * frame_consts.params.vignette.rounded) + 1.0f))) * 5.0f);
  float _612 = exp2(log2(saturate(_596 * abs(O_Uv.y + -0.5f))) * 5.0f);
  float _625 = 1.0f - ((1.0f - exp2(log2(saturate(1.0f - dot(float2(_611, _612), float2(_611, _612)))) * 6.0f)) * 0.8500000238418579f);
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _643 = ((_632 * 0.3930000066757202f) + (_633 * 0.7689999938011169f)) + (_634 * 0.1889999955892563f);
    float _648 = ((_632 * 0.3490000069141388f) + (_633 * 0.6859999895095825f)) + (_634 * 0.1679999977350235f);
    float _653 = ((_632 * 0.2720000147819519f) + (_633 * 0.5339999794960022f)) + (_634 * 0.13099999725818634f);
    float _654 = frame_consts.flashback_lut * 0.800000011920929f;
    float _659 = ((_632 * 0.2125999927520752f) + (_633 * 0.7152000069618225f)) + (_634 * 0.0722000002861023f);
    _679 = ((((_643 - _632) + ((_659 - _643) * 0.6499999761581421f)) * _654) + _632);
    _680 = ((((_648 - _633) + ((_659 - _648) * 0.6499999761581421f)) * _654) + _633);
    _681 = ((((_653 - _634) + ((_659 - _653) * 0.6499999761581421f)) * _654) + _634);
  } else {
    _679 = _632;
    _680 = _633;
    _681 = _634;
