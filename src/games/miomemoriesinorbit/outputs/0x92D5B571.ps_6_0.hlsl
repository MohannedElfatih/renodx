...
float4 main(
  ...
  float _698 = ((_678 * 1.2000000476837158f) * _683) * frame_consts.params.vignette.golden_intensity;
  if (_698 > 0.0020000000949949026f) {
    float _703 = _26 * _16;
    float _704 = _27 * _17;
    float _705 = _704 + _703;
    float _711 = frac(_705 * 0.0033333334140479565f) + -0.5f;
    float _712 = frac((_704 - _703) * 0.0033333334140479565f) + -0.5f;
    float _718 = saturate(sqrt((_712 * _712) + (_711 * _711)) * 2.0f);
    float _729 = saturate((sin((_705 * 0.01666666753590107f) - (frame_consts.time * 0.8500000238418579f)) * 1.2500001192092896f) + -0.25000008940696716f);
    float _734 = ((_729 * _729) * 0.2199999988079071f) * (3.0f - (_729 * 2.0f));
    float _735 = _734 + 0.9777389168739319f;
    float _736 = ((_718 * 0.13274884223937988f) + 0.7175776362419128f) + _734;
    float _737 = ((_718 * 0.3335757553577423f) + 0.30871906876564026f) + _734;
    float _742 = (_26 * 1080.0f) * _659;
    float _743 = _27 * 1080.0f;
    float _744 = _742 * 0.04444444552063942f;
    float _745 = _27 * 27.712812423706055f;
    float _747 = ceil(_744 - _745);
    float _750 = floor(_27 * 55.42562484741211f) + 1.0f;
    float _753 = ceil((-0.0f - _745) - _744);
    float _755 = (_750 + _747) + _753;
    float _757 = (_755 * 22.5f) + -33.75f;
    float _759 = (_747 - _753) * 11.25f;
    float _765 = (((_750 * 0.5773502588272095f) - (_747 * 0.28867512941360474f)) - (_753 * 0.28867512941360474f)) * 22.5f;
    float _768 = _757 + _759;
    float _769 = _765 + (19.485570907592773f - (_755 * 12.990381240844727f));
    float _772 = ((_755 * 25.980762481689453f) + -38.97114181518555f) + _765;
    float _773 = _759 - _757;
    float _774 = _768 - _742;
    float _775 = _769 - _743;
    float _778 = _759 - _742;
    float _779 = _772 - _743;
    float _784 = _775 * _775;
    float _791 = _773 - _742;
    float _795 = frame_consts.time * 0.30000001192092896f;
    float _796 = _769 * 0.4000000059604645f;
    float _805 = sin(((_769 * 0.04444444552063942f) + _795) * 2.0f);
    float _810 = saturate((sqrt(_805 * cos((((_796 + _768) * 0.04444444552063942f) + _795) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _814 = (_810 * _810) * (3.0f - (_810 * 2.0f));
    float _816 = (_814 * 0.6499999761581421f) + 0.3499999940395355f;
    float _831 = saturate((sqrt(sin(((_772 * 0.04444444552063942f) + _795) * 2.0f) * cos(((((_772 * 0.4000000059604645f) + _759) * 0.04444444552063942f) + _795) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _835 = (_831 * _831) * (3.0f - (_831 * 2.0f));
    float _837 = (_835 * 0.6499999761581421f) + 0.3499999940395355f;
    float _847 = saturate((sqrt(cos((((_796 + _773) * 0.04444444552063942f) + _795) * 2.0f) * _805) * 2.0f) + 0.20000004768371582f);
    float _851 = (_847 * _847) * (3.0f - (_847 * 2.0f));
    float _853 = (_851 * 0.6499999761581421f) + 0.3499999940395355f;
    float _875 = saturate(_816);
    float _876 = saturate(_837);
    float _895 = ((((saturate(11.0f - (sqrt((_779 * _779) + (_778 * _778)) / ((_835 * 0.039000000804662704f) + 0.08100000768899918f))) * _837) + (saturate(11.0f - (sqrt((_774 * _774) + _784) / ((_814 * 0.039000000804662704f) + 0.08100000768899918f))) * _816)) + (saturate(11.0f - (sqrt((_791 * _791) + _784) / ((_851 * 0.039000000804662704f) + 0.08100000768899918f))) * _853)) + (((((saturate(1.0f - (abs(_775) * 0.8333333134651184f)) * _875) + (saturate(1.0f - (abs(dot(float2(_778, _779), float2(-0.8660253882408142f, 0.5f))) * 0.8333333134651184f)) * _876)) * saturate(_853)) + ((_875 * saturate(1.0f - (abs(dot(float2(_774, _775), float2(0.8660253882408142f, 0.5f))) * 0.8333333134651184f))) * _876)) * 0.5f)) * _698;
    _906 = ((_895 * ((_735 * _735) - _692)) + _692);
    _907 = ((_895 * ((_736 * _736) - _693)) + _693);
    _908 = ((_895 * ((_737 * _737) - _694)) + _694);
  } else {
    _906 = _692;
    _907 = _693;
    _908 = _694;
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _917 = ((_907 * 0.7689999938011169f) + (_906 * 0.3930000066757202f)) + (_908 * 0.1889999955892563f);
    float _922 = ((_907 * 0.6859999895095825f) + (_906 * 0.3490000069141388f)) + (_908 * 0.1679999977350235f);
    float _927 = ((_907 * 0.5339999794960022f) + (_906 * 0.2720000147819519f)) + (_908 * 0.13099999725818634f);
    float _928 = frame_consts.flashback_lut * 0.800000011920929f;
    float _933 = ((_907 * 0.7152000069618225f) + (_906 * 0.2125999927520752f)) + (_908 * 0.0722000002861023f);
    _953 = ((((_917 - _906) + ((_933 - _917) * 0.6499999761581421f)) * _928) + _906);
    _954 = ((((_922 - _907) + ((_933 - _922) * 0.6499999761581421f)) * _928) + _907);
    _955 = ((((_927 - _908) + ((_933 - _927) * 0.6499999761581421f)) * _928) + _908);
  } else {
    _953 = _906;
    _954 = _907;
    _955 = _908;
