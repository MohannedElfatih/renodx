...
float4 main(
  ...
  float _759 = ((_739 * 1.2000000476837158f) * _744) * frame_consts.params.vignette.golden_intensity;
  if (_759 > 0.0020000000949949026f) {
    float _764 = _26 * _16;
    float _765 = _27 * _17;
    float _766 = _765 + _764;
    float _772 = frac(_766 * 0.0033333334140479565f) + -0.5f;
    float _773 = frac((_765 - _764) * 0.0033333334140479565f) + -0.5f;
    float _779 = saturate(sqrt((_773 * _773) + (_772 * _772)) * 2.0f);
    float _790 = saturate((sin((_766 * 0.01666666753590107f) - (frame_consts.time * 0.8500000238418579f)) * 1.2500001192092896f) + -0.25000008940696716f);
    float _795 = ((_790 * _790) * 0.2199999988079071f) * (3.0f - (_790 * 2.0f));
    float _796 = _795 + 0.9777389168739319f;
    float _797 = ((_779 * 0.13274884223937988f) + 0.7175776362419128f) + _795;
    float _798 = ((_779 * 0.3335757553577423f) + 0.30871906876564026f) + _795;
    float _803 = (_26 * 1080.0f) * _720;
    float _804 = _27 * 1080.0f;
    float _805 = _803 * 0.04444444552063942f;
    float _806 = _27 * 27.712812423706055f;
    float _808 = ceil(_805 - _806);
    float _811 = floor(_27 * 55.42562484741211f) + 1.0f;
    float _814 = ceil((-0.0f - _806) - _805);
    float _816 = (_811 + _808) + _814;
    float _818 = (_816 * 22.5f) + -33.75f;
    float _820 = (_808 - _814) * 11.25f;
    float _826 = (((_811 * 0.5773502588272095f) - (_808 * 0.28867512941360474f)) - (_814 * 0.28867512941360474f)) * 22.5f;
    float _829 = _818 + _820;
    float _830 = _826 + (19.485570907592773f - (_816 * 12.990381240844727f));
    float _833 = ((_816 * 25.980762481689453f) + -38.97114181518555f) + _826;
    float _834 = _820 - _818;
    float _835 = _829 - _803;
    float _836 = _830 - _804;
    float _839 = _820 - _803;
    float _840 = _833 - _804;
    float _845 = _836 * _836;
    float _852 = _834 - _803;
    float _856 = frame_consts.time * 0.30000001192092896f;
    float _857 = _830 * 0.4000000059604645f;
    float _866 = sin(((_830 * 0.04444444552063942f) + _856) * 2.0f);
    float _871 = saturate((sqrt(_866 * cos((((_857 + _829) * 0.04444444552063942f) + _856) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _875 = (_871 * _871) * (3.0f - (_871 * 2.0f));
    float _877 = (_875 * 0.6499999761581421f) + 0.3499999940395355f;
    float _892 = saturate((sqrt(sin(((_833 * 0.04444444552063942f) + _856) * 2.0f) * cos(((((_833 * 0.4000000059604645f) + _820) * 0.04444444552063942f) + _856) * 2.0f)) * 2.0f) + 0.20000004768371582f);
    float _896 = (_892 * _892) * (3.0f - (_892 * 2.0f));
    float _898 = (_896 * 0.6499999761581421f) + 0.3499999940395355f;
    float _908 = saturate((sqrt(cos((((_857 + _834) * 0.04444444552063942f) + _856) * 2.0f) * _866) * 2.0f) + 0.20000004768371582f);
    float _912 = (_908 * _908) * (3.0f - (_908 * 2.0f));
    float _914 = (_912 * 0.6499999761581421f) + 0.3499999940395355f;
    float _936 = saturate(_877);
    float _937 = saturate(_898);
    float _956 = ((((saturate(11.0f - (sqrt((_840 * _840) + (_839 * _839)) / ((_896 * 0.039000000804662704f) + 0.08100000768899918f))) * _898) + (saturate(11.0f - (sqrt((_835 * _835) + _845) / ((_875 * 0.039000000804662704f) + 0.08100000768899918f))) * _877)) + (saturate(11.0f - (sqrt((_852 * _852) + _845) / ((_912 * 0.039000000804662704f) + 0.08100000768899918f))) * _914)) + (((((saturate(1.0f - (abs(_836) * 0.8333333134651184f)) * _936) + (saturate(1.0f - (abs(dot(float2(_839, _840), float2(-0.8660253882408142f, 0.5f))) * 0.8333333134651184f)) * _937)) * saturate(_914)) + ((_936 * saturate(1.0f - (abs(dot(float2(_835, _836), float2(0.8660253882408142f, 0.5f))) * 0.8333333134651184f))) * _937)) * 0.5f)) * _759;
    _967 = ((_956 * ((_796 * _796) - _753)) + _753);
    _968 = ((_956 * ((_797 * _797) - _754)) + _754);
    _969 = ((_956 * ((_798 * _798) - _755)) + _755);
  } else {
    _967 = _753;
    _968 = _754;
    _969 = _755;
  ...
  if (frame_consts.flashback_lut > 0.0f) {
    float _978 = ((_968 * 0.7689999938011169f) + (_967 * 0.3930000066757202f)) + (_969 * 0.1889999955892563f);
    float _983 = ((_968 * 0.6859999895095825f) + (_967 * 0.3490000069141388f)) + (_969 * 0.1679999977350235f);
    float _988 = ((_968 * 0.5339999794960022f) + (_967 * 0.2720000147819519f)) + (_969 * 0.13099999725818634f);
    float _989 = frame_consts.flashback_lut * 0.800000011920929f;
    float _994 = ((_968 * 0.7152000069618225f) + (_967 * 0.2125999927520752f)) + (_969 * 0.0722000002861023f);
    _1014 = ((((_978 - _967) + ((_994 - _978) * 0.6499999761581421f)) * _989) + _967);
    _1015 = ((((_983 - _968) + ((_994 - _983) * 0.6499999761581421f)) * _989) + _968);
    _1016 = ((((_988 - _969) + ((_994 - _988) * 0.6499999761581421f)) * _989) + _969);
  } else {
    _1014 = _967;
    _1015 = _968;
    _1016 = _969;
