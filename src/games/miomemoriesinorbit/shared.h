#ifndef SRC_MIO_MEMORIES_IN_ORBIT_SHARED_H_
#define SRC_MIO_MEMORIES_IN_ORBIT_SHARED_H_
...
#define RENODX_RENO_DRT_WHITE_CLIP                    20.f
...
#endif  // SRC_MIO_MEMORIES_IN_ORBIT_SHARED_H_
