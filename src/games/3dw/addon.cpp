...
BOOL APIENTRY DllMain(HMODULE h_module, DWORD fdw_reason, LPVOID lpv_reserved) {
  ...
  const auto common_view_upgrades = false;
  ...
  const auto common_aspect_ratio = 16.f / 9.f;
  switch (fdw_reason) {
    case DLL_PROCESS_ATTACH:
      ...
      renodx::mods::swapchain::use_resource_cloning = common_view_upgrades;
      ...
      */
      ...
      renodx::mods::swapchain::resource_upgrade_infos.push_back({
          ...
          .use_resource_view_cloning = common_view_upgrades,
  ...
  // Ryujinx swapchain modification is broken with custom ReShade right now
